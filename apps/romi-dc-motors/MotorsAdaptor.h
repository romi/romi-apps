 ...
 */
#ifndef ROMI_MOTORSADAPTER_H
#define ROMI_MOTORSADAPTER_H
...
namespace romi {
        ...
        class MotorsAdaptor : public rcom::IRPCHandler
        {
        protected:
        ...
        public:
                explicit MotorsAdaptor(IMotorDriver& motors);
                ~MotorsAdaptor() override = default;
