...
#ifndef ROMI_DATALOG_H
#define ROMI_DATALOG_H
...
namespace romi {
        ...
        class IgnoreMessages : public rcom::IMessageListener
        {
        public:
                IgnoreMessages() {}
                virtual ~IgnoreMessages() = default;
                
                void onmessage(rcom::IWebSocketServer&, rcom::IWebSocket&,
                               rcom::MemBuffer&, rcom::MessageType) override {
                }
        };
        ...
        protected:
                ...
                void try_create_hub(rcom::ILog& log, rcom::ISystem& system);
