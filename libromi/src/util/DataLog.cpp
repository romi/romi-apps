...
namespace romi {
        ...
        DataLog::DataLog(const std::filesystem::path& filepath,
                         rcom::ILog& log,
                         rcom::ISystem& system)
                : DataLog(filepath.string(), log, system)
        {
        }
        ...
        void DataLog::try_create_hub(rcom::ILog& log, rcom::ISystem& system)
        {
                try {
                        hub_ = rcom::MessageHub::create("datalog", "log",
                                                        listener_,
                                                        log, system);
