...
int main(int argc, char **argv)
{
        ...
        try {
                ...
                // TODO: get list of pins from config file
                // From: https://www.waveshare.com/wiki/RPi_Relay_Board_(B)
                /*
                  Channel   | RPi pin number | BCM
                  Channel 1   29               5 	
                  Channel 2   31               6 	
                  Channel 3   33               13 	
                  Channel 4   36               16 	
                  ...
                  Channel 8   37               26 	 
                */
                std::vector<uint32_t> pins = {5, 6, 13, 16, 19, 20, 21, 26};
                
                romi::GpioRelayBoard board(pins);
                romi::RelayBoardAdaptor adaptor(board);
