...
class helix_tests : public ::testing::Test
{
protected:
        int32_t pos_[3];
...
TEST_F(helix_tests, test_zero_travel)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_one_up)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_one_down)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_two_up)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_semi_circle_ccw)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_semi_circle_cw)
{
        // Arrange
...
TEST_F(helix_tests, test_travel_semi_circle_and_one_up)
{
        // Arrange
...
TEST_F(helix_tests, test_helix_full_circle)
{
        // Arrange
        ...
        EXPECT_CALL(controller, get_position(_))
                .WillRepeatedly(Invoke(this, &helix_tests::get_position));
        EXPECT_CALL(controller, moveto(_,_,_,_))
                .WillRepeatedly(Invoke(this, &helix_tests::moveto));
        EXPECT_CALL(controller, move(_,_,_,_))
                .WillRepeatedly(Invoke(this, &helix_tests::move));
