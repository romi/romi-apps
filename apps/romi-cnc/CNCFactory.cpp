...
namespace romi {
        ...
        CNCFactory::CNCFactory() : _controller()
        {}
        
        ICNCController& CNCFactory::create_controller(IOptions &options,
        ...
        void CNCFactory::instantiate_controller(IOptions &options,
                                                  nlohmann::json &cnc_config,
                                                  nlohmann::json &ports_config)
        {
        ...
        std::string CNCFactory::get_controller_classname_in_config(nlohmann::json &config)
        {
        ...
        void CNCFactory::instantiate_controller(const std::string& classname,
                                                  IOptions &options,
                                                  nlohmann::json &ports_config)
        {
        ...
        void CNCFactory::instantiate_fake_controller()
        {
                _controller = std::unique_ptr<ICNCController>(new FakeCNCController());
        }
        
        void CNCFactory::instantiate_stepper_controller(IOptions &options,
                                                          nlohmann::json &ports_config)
        {
        ...
        std::string CNCFactory::get_stepper_controller_device_in_config(nlohmann::json &ports_config)
        {
